...
function User() {
    ...
    this.users = [
        { id: 1, firstname: 'john', lastname:'joe', password: 'n4bQgYhMfWWaL+qgxVrQFaO/TxsrC4Is0V1sFbDwCgg=', email:'jim@example.com' },
    ...
    this.insertIntoHistory = async (user_id, inputTemp, outputTemp) => {
        ...
        if (!this.historyRecords.user_id){
            this.historyRecords[user_id.toString()] = [];
        }    
